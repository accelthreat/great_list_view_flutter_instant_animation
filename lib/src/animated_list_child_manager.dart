...
class AnimatedSliverMultiBoxAdaptorElement extends RenderObjectElement
  ...
  void onUpdateOnStopReording(int fromIndex, int toIndex) {
    assert(toIndex != null && _reorderFromIndex == fromIndex);
  ...
  Element updateChild(
    ...
    // if (child != null &&
    //     child.renderObject == renderObject.reorderingRemovedChild) {
    //   if (newSlot != child.slot) {
    //     updateSlotForChild(child, newSlot);
    //     assert(child.renderObject == renderObject.reorderingRemovedChild);
    //   }
    //   return child;
    // }
...
class _BuildUpdate {
  ...
  _BuildUpdate({this.index, this.removeCount, this.insertCount, this.type});
}

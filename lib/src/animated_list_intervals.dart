...
typedef AnimatedListAnimationItemBuilder = Widget Function(
    ...
    NullableIndexedWidgetBuilder oldBuilder,
    int oldIndex,
    NullableIndexedWidgetBuilder newBuilder,
    int newIndex,
...
class AnimatedListInterval extends Comparable {
  AnimatedListIntervalState _state;
  AnimatedListIntervalState get state => _state;

  int _index;
  int get index => _index;

  int _insertCount, _removeCount;
  ...
  NullableIndexedWidgetBuilder _removeItemBuilder;
  ...
  NullableIndexedWidgetBuilder get removeItemBuilder => _removeItemBuilder;
  ...
  AnimatedListInterval.change({
    ...
    @required int index,
    @required int changeCount,
    @required NullableIndexedWidgetBuilder removeItemBuilder,
...
class _AnimatedListAnimationController {
  ...
  dynamic Function() _whenComplete;
  ...
  _AnimatedListAnimationController({
    ...
    Curve curve,
    @required dynamic Function() whenComplete,
    double startingControllerValue = 0.0,
    bool startNow = true,
  }) {
    assert(vsync != null &&
        duration != null &&
        startingControllerValue != null &&
        startNow != null &&
        whenComplete != null);
    _curve = curve;
  ...
  void start() {
    if (!_controller.isAnimating) {
      ...
      if (_whenComplete != null) future.whenComplete(_whenComplete);
    }
  }
  ...
  void restart(
      ...
      @required dynamic Function() whenComplete,
      bool startNow = true}) {
    assert(startNow != null && whenComplete != null);
